...
void Test(std::string expected_result_file, int seed = 10, int data_int = 100, double mutation_rate = 0.002, 
    ...
    double sym_int = 0,  int grid_x = 5, int grid_y = 5, int updates = 10, 
    ...
    int burst_time = 10, double host_repro_res = 1000,double sym_lysis_res = 1, 
	  double sym_horiz_trans_res = 100, int start_moi = 1/25, bool grid = 0,double donation = 0.01) {
...
TEST_CASE( "End To End" ) {
  Test("vert_trans_0", 17, 100, 1, 5, 1, -2, -2, 100, 100, 1001, 1, 0, 1, 4, 2, 1000, 0.3, 100, 1, 0);
